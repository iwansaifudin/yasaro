		...
		<table border='0' cellpadding='0' cellspacing='15'><tbody><tr><td>
			...
			<table border="0" cellspacing="0" cellpadding="3"><tbody>
				...
				<tr>
					<td>Kelompok</td>
					<td>:</td>
					<td><input type="text" id="stockholder_cluster_from" value="<?=$stockholder_cluster_from?>" style="border: none; font-size: 110%; width: 350px" placeholder="<?=$blank2;?>" readonly /></td>
				</tr>
				<tr>
					<td>Jumlah Saham</td>
					<td>:</td>
