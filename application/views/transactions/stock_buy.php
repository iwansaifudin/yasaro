...
?>
	...
	<div style="height:690px; overflow:hidden; position:relative; width:99.9%;">
	<div style="height:540px; width:700px; border: 1px solid darkgray; background-color: white; position:relative; top:25px; text-align:left; margin-left:auto; margin-right:auto;">

		<h1>TRANSAKSI PEMBELIAN SAHAM</h1>
...
<script type='text/javascript'>
	...
	function stock_buy_detail_append(stock_no, total_price, trans_status, qty_flag) {
		...
		if(trans_status == 0) {
		str +="	<a href='#' class='nounderline' style='font-size: 90%' onclick='stock_buy_detail_remove("+stock_no+")'>[-]</a> ";
		}
		str += stock_no+".&nbsp;</td>"
	...
	function stock_buy_detail_remove(stock_no) {
