...
<script type='text/javascript'>
	...
	function shu_division_detail_append(stock_no, trans_status, qty_flag) {
		...
		if(trans_status == 0) {
		str +="	<a href='#' class='nounderline' style='font-size: 90%' onclick='shu_division_detail_remove("+stock_no+")'>[-]</a> ";
		}
		str += stock_no+".&nbsp;</td>"
	...
	function shu_division_detail_remove(stock_no) {
